...
public class RecommendBookListActivityAdapter extends BaseRVAdapter<RecommendBookList.RecommendBook> {
    private OnRvItemClickListener mOnRvItemClickListener;

    public RecommendBookListActivityAdapter(Context context, List<RecommendBookList.RecommendBook> list,
