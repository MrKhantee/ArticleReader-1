 ...
 * Desc：完全复制MaterialProgressDrawable，这是一个Drawable，我们需要将它放在一个View上，比如ImageView
 */
...
public class CircleProgress extends Drawable implements Animatable {
    ...
    public CircleProgress(Context context, View parent) {
        mParent = parent;
     ...
     *
     * @param size CircleProgress.LARGE 和CircleProgress.DEFAULT
     */
