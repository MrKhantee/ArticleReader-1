...
public class OverlappedWidget extends CustomReadView {
    private Path mPath0;
    ...
    public OverlappedWidget(Context context, String bookId,
                            List<BookMixAToc.mixToc.Chapters> chaptersList, OnReadStateChangeListener listener) {
    ...
    protected void setBitmaps(Bitmap mCurPageBitmap, Bitmap mNextPageBitmap) {
        mCurPageBitmap = mCurPageBitmap;
        mNextPageBitmap = mNextPageBitmap;
    }
